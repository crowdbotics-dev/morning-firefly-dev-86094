...
## Project Structure
    ...
    ├── morning_firefly_dev_86094  # Django project configurations
...
1. Clone this repo and `cd morning_firefly_dev_86094`
...
2. Clone this repo and `cd morning_firefly_dev_86094`
